...
void CClydeEEPROM::reset() {
  ...
  //original sunset colors: 9 steps:
  ...
  RGB sunsetColors[sunsetSteps] = {RGB(242, 103, 31), RGB(201, 27, 38), RGB(156, 15, 95), RGB(96, 4, 122), RGB(22, 10, 71)};
  uint32_t sunsetIntervals[sunsetSteps] = {60000, 60000, 60000, 60000, 60000}; //real
